        ...
        <div>
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <h2 className="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">M5. Actividad_1</h2>
                    <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Javier Santos Pérez</h1>
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">A01198909</p>
                    </div>
